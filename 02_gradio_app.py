...
# Si lo hiciéramos dentro de la función de inferencia, se repetiría en cada
# solicitud del usuario, lo que sería muy lento.
...
def extraer_y_emparejar(img0_bgr: np.ndarray, img1_bgr: np.ndarray):
    """
    Extrae características con ALIKED y las empareja con LightGlue.
...
def inferencia(img0_rgb: np.ndarray, img1_rgb: np.ndarray):
    ...
    Devolvemos:
        ...
        - Texto con las estadísticas del resultado para gr.Textbox
    """
    ...
    stats = (
        ...
        f"Correspondencias LightGlue: {total}\n"
